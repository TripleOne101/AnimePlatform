...
let amime1 = new movies(1, "Naruto", "In a village where he was rejected for unknown reasons, Naruto Uzumaki, a young ninja who seeks to become the Hokage, the leader of his village", "Action Drama Shonen", "anime", "./assets/anime-1.png", "./assets/animeb-1.png","https://www.youtube.com/");
let amime2 = new movies(2, "One Piece", "Follows the adventures of Monkey D. Luffy and his pirate crew in order to find the greatest treasure ever left by the legendary Pirate, Gold Roger. The famous mystery treasure named One Piece", "Action Adventure", "anime", "./assets/anime-2.png", "./assets/anime-2b.png");
let amime3 = new movies(3, "Attack on Titan", "After his hometown is destroyed and his mother is killed, young Eren Jaeger vows to cleanse the earth of the giant humanoid Titans that have brought humanity to the brink of extinction.", "Action Adventure", "anime", "./assets/anime-3.png", "./assets/anime-3b.png");
